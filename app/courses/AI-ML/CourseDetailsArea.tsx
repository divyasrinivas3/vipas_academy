  ...
  const curriculum: CurriculumSection[] = [
    {
      ...
      lessons: [
        ...
        { id: "l4", lesson_title: "AI vs ML vs Deep Learning", lesson_order: 4 },
        { id: "l5", lesson_title: "Overview of supervised, unsupervised & reinforcement learning", lesson_order: 5 },
      ],
    },
    {
      id: "mod2",
      ...
      lessons: [
        ...
        { id: "l9", lesson_title: "Working with NumPy, Pandas, and Matplotlib", lesson_order: 4 },
        { id: "l10", lesson_title: "Data visualization and basic analytics", lesson_order: 5 },
      ],
    },
    {
      id: "mod3",
      ...
      lessons: [
        ...
        { id: "l14", lesson_title: "Basic concepts of optimization (cost function, gradient descent)", lesson_order: 4 },
      ],
    },
    {
      id: "mod4",
      ...
      lessons: [
        ...
        { id: "l18", lesson_title: "Feature selection and dimensionality reduction (PCA)", lesson_order: 4 },
        { id: "l19", lesson_title: "Splitting datasets and model validation", lesson_order: 5 },
      ],
    },
    {
      id: "mod5",
      ...
      lessons: [
        ...
        { id: "l23", lesson_title: "Support Vector Machines (SVM)", lesson_order: 4 },
        { id: "l24", lesson_title: "Model evaluation metrics (accuracy, precision, recall, F1-score)", lesson_order: 5 },
      ],
    },
    {
      id: "mod6",
    ...
    },
    {
      ...
      lessons: [
        ...
        { id: "l32", lesson_title: "Convolutional Neural Networks (CNNs) – for image data", lesson_order: 4 },
        { id: "l33", lesson_title: "Recurrent Neural Networks (RNNs), LSTM, GRU – for sequence data", lesson_order: 5 },
      ],
    },
    {
      id: "mod8",
      ...
      lessons: [
        ...
        { id: "l37", lesson_title: "Language models and Transformers (BERT, GPT overview)", lesson_order: 4 },
      ],
    },
    {
      id: "mod9",
      ...
      lessons: [
        ...
        { id: "l41", lesson_title: "Model monitoring and retraining", lesson_order: 4 },
      ],
    },
    {
      id: "mod10",
      ...
      lessons: [
        ...
        { id: "l46", lesson_title: "Recommendation System (movies, products, or courses)", lesson_order: 5 },
      ],
    },
  ];
